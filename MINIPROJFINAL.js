...
class Produto {
    ...
    actualizarPreco(novoPreco) {
        ...
        console.log(`O preço actualizado do produto ${this.nome} é ${this.preco.toFixed(2)} euros.`);
    };
    ...
    alteracaoPrecoSaldos(desconto) {
        ...
        if (desconto > 0 && desconto < 1) { 
            ...
            this.preco = this.preco.toFixed(2); 
            informacaoSaldos = (`Produto ${this.nome} encontra-se em saldos de ${desconto}%. Valor actual é de ${this.preco}€`)
            console.log(informacaoSaldos); 
        }
    } 
}
